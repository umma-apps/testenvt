// tableextension 52178713 Customers extends Customer
// {
//     Caption = 'Customer';
//     LookupPageID = 22;
//     fields
...
//         {
//             DataClassification = ToBeClassified;
//             OptionCaption = 'Registration,Current,Alluminae,Dropped Out,Deffered,Suspended,Expulsion,Discontinued,Deferred,Deceased,Transferred,Disciplinary,Unknown,Completed not graduated,Graduated no Certificates,Graduated with Certificate,Did Not Report,Absconded,Transferred from MSN,Transferred to MSN,Resit,Halt';
//             OptionMembers = Registration,Current,Alluminae,"Dropped Out",Deffered,Suspended,Expulsion,Discontinued,Deferred,Deceased,Transferred,Disciplinary,Unknown,"Completed not graduated","Graduated no Certificates","Graduated with Certificate","Did Not Report",Absconded,"Transferred from MSN","Transferred to MSN",Resit,Halt;
