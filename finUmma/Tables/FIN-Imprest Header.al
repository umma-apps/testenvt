table 52178708 "FIN-Imprest Header"
{
    ...
    fields
    {
        ...
        field(87; "Account No."; Code[20])
        {
            ...
            begin
                ...
                IF Cust.GET("Account No.") THEN BEGIN
                    ...
                    hrEmp.Reset();
                    hrEmp.SetRange("No.", "Account No.");
                    if hrEmp.Find('-') then begin
                        "payees bank name" := hrEmp."Main Bank Name";
                        "payees bank code" := hrEmp."Main Bank";
                        "payees  branch name" := hrEmp."Branch Bank Name";
                        "payees Branch code" := hrEmp."Branch Bank";
                        "payees bank account" := hrEmp."Bank Account Number";
                    end;
        ...
        field(89; Purpose; Text[500])
        {
            Caption = 'Description Of Purchsae';
        }
        ...
        field(50015; "Job Title"; Text[100])
        {
