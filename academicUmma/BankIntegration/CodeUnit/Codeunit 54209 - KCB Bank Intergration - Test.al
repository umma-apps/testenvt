codeunit 54209 "KCB Bank Intergration - Test"
{
    Permissions = 
        ...
        tabledata "KCB Bank Intergration - Test" = RI;
    ...
    procedure GetPayTrans(inbankreference: Code[50]; indebitaccount: Code[20]; intransactionDate: Code[20]; inbillAmount:Decimal; inpaymentMode: Code[20]; inphonenumber: Code[20]; incustomerRefNumber: Code[20]; indebitcustname: Text[150]) Status: Text[250]
    var
        Cust: Record Customer;
        BankIntergration: Record "KCB Bank Intergration - Test";
    begin
