...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/Exam Card.rdl';
    ...
    dataset
    {
        dataitem("ACA-Course Registration"; "ACA-Course Registration")
        {
            ...
            column(MASENO_UNIVERSITY_EXAM_CARDCaption; MASENO_UNIVERSITY_EXAM_CARDCaptionLbl)
            {
            }
    ...
    var
        ...
        UDesc: Text[200];
        UnitR: Record 61517;
        MASENO_UNIVERSITY_EXAM_CARDCaptionLbl: Label 'MASENO UNIVERSITY EXAM CARD';
