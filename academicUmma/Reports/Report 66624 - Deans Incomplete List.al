report 66624 "Deans Incomplete List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/Deans Incomplete List.rdl';
    ...
    dataset
    {
        dataitem(StudentsClassification; 66630)
        {
            ...
            DataItemTableView = WHERE("Final Classification Pass" = FILTER('No'),
            ...
            begin
                ...
                ACAResultsStatus.SETRANGE(ACAResultsStatus.Code, StudentsClassification."Final Classification");
