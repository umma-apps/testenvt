report 78052 "Exams Final Pass List C2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/Exams Final Pass List C2.rdl';
    ...
    dataset
    {
        dataitem(SenateHeaders; "ACA-Senate Reports Header")
        {
            ...
            dataitem(ExamsCoreg; "ACA-Exam. Course Registration")
            {
                ...
                dataitem(ClsUnits; "ACA-Exam Classification Units")
                {
                    CalcFields = Pass;
                    ...
                    column(UnitCode; ClsUnits."Unit Code")
                    {
                    }
                    column(UnitDescription; ClsUnits."Unit Description")
                    {
                    }

                    trigger OnAfterGetRecord()
                    begin
                        IF ClsUnits.Pass THEN CurrReport.SKIP;
                    end;
                }
