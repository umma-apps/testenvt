/// <summary>
/// Page ACA-Acad. E-Campus Role Center (ID 69255).
/// </summary>
page 69255 "ACA-Acad. E-Campus Role Center"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
        ...
        area(processing)
        {
            ...
            group(Academics)
            {
                group(Academics2)
                {
                    ...
                    action("ACA-Units Registration Summary")
                    {
                        Image = Opportunity;
        ...
        area(sections)
        {
            group("PSSP Admissions")
            {
                ...
                action("Enquiry list")
                {
                    ...
                    ApplicationArea = All;
                    //RunPageView = WHERE(Campus Code=FILTER('ECAMPUS'));
                }
                ...
                action(Applications)
                {
                    ...
                    RunPageView = WHERE(Campus = FILTER('ECAMPUS'));
                    ApplicationArea = All;
                }
            ...
            group("Students Management")
            {
                ...
                action(Registration)
                {
                    ...
                    RunObject = Page 68836;
                    ApplicationArea = All;
                    //RunPageView = WHERE("Global Dimension 1 Code"=FILTER('ECAMPUS'));
                }
