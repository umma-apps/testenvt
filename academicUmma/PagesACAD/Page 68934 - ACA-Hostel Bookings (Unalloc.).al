page 68934 "ACA-Hostel Bookings (Unalloc.)"
{
    ...
    actions
    {
        area(creation)
        {
            ...
            action(Allocateroomfinal)
            {
                Caption = 'Allocate Room And Bill';
                Image = "Action";
                Promoted = true;
                        ...
                        IF Cust."Hostel Black Listed" = FALSE THEN BEGIN
                            ...
                            IF Creg1.FIND('-') THEN BEGIN
                                ...
                                IF prog.GET(Creg1.Programmes) THEN BEGIN
                                    ...
                                    ELSE
                                        IF Creg1."Settlement Type" = 'SSS' THEN
                                            settlementType := settlementType::SSS//GSS-2021
                                        ELSE
                                            IF Creg1."Settlement Type" = 'GSS' THEN
                                                settlementType := settlementType::GSS
                                            else
                                                IF Creg1."Settlement Type" = 'GSS-2021' THEN
                                                    settlementType := settlementType::SSS//GSS-2021
                                                ELSE
                                                    IF Creg1."Settlement Type" = 'GSS-2022' THEN
                                                        settlementType := settlementType::GSS
                                                    else
                                                        IF Creg1."Settlement Type" = 'ODEL' THEN
                                                            settlementType := settlementType::GSS
                                                        else
                                                            IF Creg1."Settlement Type" = 'SSS SEP 2024' THEN
                                                                settlementType := settlementType::SSS//GSS-2021
                                                            ELSE
                                                                IF Creg1."Settlement Type" = 'SSS-2014' THEN
                                                                    settlementType := settlementType::GSS
                                                                else
                                                                    IF Creg1."Settlement Type" = 'SSS-2021' THEN
                                                                        settlementType := settlementType::GSS
                                                                    else
                                                                        IF Creg1."Settlement Type" = 'SSS-2022' THEN
                                                                            settlementType := settlementType::GSS
                                                                        else
                                                                            IF Creg1."Settlement Type" = 'SSS-2024' THEN
                                                                                settlementType := settlementType::SSS//GSS-2021
                                                                            ELSE
                                                                                IF Creg1."Settlement Type" = 'SSSGRA' THEN settlementType := settlementType::GSS;
            ...
            //                         ELSE
            //                             IF Creg1."Settlement Type" = 'SSS' THEN
            //                                 settlementType := settlementType::SSS
            //                             ELSE
            //                                 IF Creg1."Settlement Type" = 'GSS' THEN settlementType := settlementType::GSS;
            //                     END;
    ...
    var
        ...
        settlementType: Option " ",JAB,SSP,"Special Programme",SSS,GSS;
            ...
            REPEAT
                ...
                IF NOT StudentCharges.FIND('-') THEN BEGIN
                    ...
                    IF coReg.FIND('-') THEN BEGIN
                        ...
                        StudentCharges.Description := 'Accommodation Fees ' + REC.Semester;
                        // IF Blocks.GET("Hostel No") THEN
                        // StudentCharges.Amount:=Blocks."Cost Per Occupant"REC
                        // ELSE
