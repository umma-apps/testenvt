/// <summary>
/// Page ACA-LecEvaluation Role Center (ID 9052).
/// </summary>
page 40004 "ACA-LecEvaluation Role Center"
{
    PageType = RoleCenter;
        ...
        area(reporting)
        {
            group(Periodic)
            {
                ...
                group("BeforeExams")
                {
                    ...
                    action("ACA-Lecturers Evaluation")
                    {
                        Image = Evaluate;
                        RunObject = Report 61035;
                        ApplicationArea = All;
                    }
                }
