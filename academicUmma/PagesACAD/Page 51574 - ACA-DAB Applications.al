page 51574 "ACA-DAB Applications"
{
    ...
    SourceTableView = WHERE(Status = FILTER(Open), "Submission Status" = filter(" "));
    ...
    begin
        ...
        if usersetup.Find('-') then begin
            Rec.SetFilter("Programme Department", '=%1', usersetup."Global Dimension 2 Code");
        end ELSE
            error('Contact your administrator')


        /* Rec.FilterGroup(2);
        Rec.SetRange("Programme Department", usersetup."Global Dimension 2 Code");
