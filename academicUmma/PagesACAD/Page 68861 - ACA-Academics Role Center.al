        ...
        area(processing)
        {
            ...
            group("Admission Reports")
            {
                group(AdminReports)
                {
                    ...
                    {
                        Caption = 'Admissions Master Report';
                        Image = Report;
                        RunObject = Report "ACA-Applicants Summary";
                        ApplicationArea = All;
                        //Visible = false;
                    }
            ...
            group("Academic reports")
            {
                group(AcadReports)
                {
                    ...
                    action("Units of Offer")
                    {
                        Image = Report;

                        RunObject = Report "Units On Offer Report";
                        ApplicationArea = All;
                    }
                    action(suppStud)
                    {
