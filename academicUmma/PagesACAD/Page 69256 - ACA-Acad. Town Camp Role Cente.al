/// <summary>
/// Page ACA-Acad. Town Camp Role Cente (ID 69256).
/// </summary>
page 69256 "ACA-Acad. Town Camp Role Cente"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
        ...
        area(sections)
        {
            group("PSSP Admissions")
            {
                ...
                action("Enquiry list")
                {
                    ...
                    ApplicationArea = All;
                    // RunPageView = WHERE("Campus Code"=FILTER(KISUMU));
                }
                ...
                action(Applications)
                {
                    ...
                    ApplicationArea = All;
                    //  //RunPageView = WHERE(Campus = FILTER(KISUMU));
                }
            ...
            group("KUCCPS Admission")
            {
                ...
                action("pendingDocumentsVerification")
                {
                    Caption = 'pending documents verification';
                    RunObject = Page 68483;
                    ApplicationArea = All;
                ...
                action("pendingPaymentsConfirmation")
                {
                    Caption = 'pending payments confirmation';
                    RunObject = Page 68522;
                    ApplicationArea = All;
                ...
                action("pendingAdmissionConfirmation")
                {
                    Caption = 'pending Admission confirmation';
                    RunObject = Page 68523;
                    ApplicationArea = All;
            ...
            group("Students Management")
            {
                ...
                action(Registration)
                {
                    ...
                    RunObject = Page 68836;
                    ApplicationArea = All;
                    //RunPageView = WHERE("Global Dimension 1 Code"=FILTER(KISUMU));
                }
