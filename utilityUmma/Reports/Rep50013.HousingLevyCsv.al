report 86010 "Housing Levy Csv(Combined)"
{
            ...
            begin
                ...
                */
                ...
                if PRPeriodTrans.FindFirst() then begin
                    ...
                    if PRPeriodTrans.FindFirst() then begin
                        gpay := PRPeriodTrans.Amount + Lumpsum;
                    end
                ...
                if ExportCSV then begin
                    ...
                    CSVBuffer.InsertEntry(LineNo, 4, format(gpay, 0, 2));
    ...
    begin
        if ExportCSV then begin
            FileName := 'HousingLevyCombined.csv';
