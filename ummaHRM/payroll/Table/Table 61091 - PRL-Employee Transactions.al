    ...
    fields
    {
        ...
        field(2; "Transaction Code"; Code[30])
        {
            ...
            begin
                ...
                objTransCodes.Reset();
                objTransCodes.SetRange("Transaction Code", "Transaction Code");
                if objTransCodes.Find('-') then begin
                ...
                if prlPeriod.Find('-') then begin
                    "Payroll Period" := prlPeriod."Date Opened";
                    "Period Month" := prlPeriod."Period Month";
                    "Period Year" := prlPeriod."Period Year";
                end;
        ...
        {
            CalcFormula = Count("HRM-Employee (D)" WHERE("No." = FIELD("Employee Code"), Status = FILTER(Active)));
            FieldClass = FlowField;
        }
