...
{
    DefaultLayout = RDLC;
    RDLCLayout = './payroll/Report/Casual/CasualPayrollSummary.rdl';
    ...
    dataset
    {
        dataitem(DataItem1000000000; 349)
        {
            ...
            dataitem(DataItem1; "HRM-Employee (D)")
            {
                ...
                begin
                    ...
                    IF ((BasicPay = 0) OR ("HRM-Employee (D)"."No." = '') OR ("HRM-Employee (D)".Status = 1)) THEN //showdet:=FALSE;
                        CurrReport.SKIP;
                end;
