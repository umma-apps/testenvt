report 85538 "WorkStudy Summary Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './payroll/Report/Casual/SSR/WorkstudySummaryReport.rdl';

    dataset
    {
        dataitem(DataItem6207; "PRL Workstudy Hours Worked")
        {
            ...
            column(Hours_Worked;"Hours Worked")
            {
            }
