report 70281 "IP-Company Payslip"
{
    DefaultLayout = RDLC;
    RDLCLayout = './payroll/Report/Casual/IPCompanyPayslip.rdl';

    dataset
    {
        dataitem(DataItem1; 70250)
        {
    ...
    var
        ...
        NoOfColumns: Integer;
        ColumnNo: Integer;
        prPeriod_Transactions: Record 70252;
        "PRL-Casual Payroll Periods": Record "PRL-Casual Payroll Periods";
}
