report 72025 "PRL Detailed simplified Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './payroll/Report/SSR/PRL Detailed simplified Report.rdl';
    ...
    dataset
    {
        dataitem("PRL-Period Transactions"; "PRL-Period Transactions")
        {
            DataItemTableView = SORTING("Payroll Period", "Group Order", "Sub Group Order")
                                ORDER(Ascending)
                                WHERE("Transaction Code" = FILTER('<>TXEP'),
            ...
            begin
                ...
                HRMEmployeeD.RESET;
                HRMEmployeeD.SETRANGE(HRMEmployeeD."No.", "PRL-Period Transactions"."Employee Code");
                ...
                IF "PRL-Period Transactions"."Group Text" IN ['NBK'] THEN CurrReport.SKIP;
                //D-1101
                IF "PRL-Period Transactions"."Transaction Code" IN ['D-1101' .. 'D-1107', 'D-1109' .. 'D-1122', 'D-430' .. 'D-976']
                  THEN
                    CurrReport.SKIP;
                ...
                IF "PRL-Period Transactions"."Transaction Code" IN ['TOT-DED', 'PAYE', 'NHIF'] THEN "PRL-Period Transactions"."Group Text" := 'TOTAL DEDUCTIONS';
